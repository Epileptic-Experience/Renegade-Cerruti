...
const CheckoutPage = () => {
    ...
    const handleChange = (e) => {
        ...
        console.log("info comprador", inputValue)
            ...
            >
                ...
                {succesOrder ? (
                    ...
                    <Modal.Body>
                        ...
                        <input type="text" name='direction' value={inputValue.direction} onChange={handleChange} placeholder='direccion'></input>
                    </Modal.Body>
                )}
                <Modal.Footer>
                    {succesOrder === undefined && <Button className='enviar' type='Submit' onClick={handleSubmit}>enviar</Button>}
                </Modal.Footer>
            </Modal >
        );
    }
